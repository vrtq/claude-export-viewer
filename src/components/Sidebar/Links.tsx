...
export default function Links() {
    return (
        <div className="w-full flex flex-col gap-2 font-sans">
            <Link to="import" className="flex flex-row gap-6 w-full">
                <div className="size-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="bg-card text-muted-foreground rounded-full p-0.5">
            ...
            <Link to="recents" className="flex flex-row gap-6 w-full">
                <div className="size-5">
